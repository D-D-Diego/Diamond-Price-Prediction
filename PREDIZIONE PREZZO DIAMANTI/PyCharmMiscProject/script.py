...
axes[0, 1].set_title('2. Prezzi Reali vs Predetti')

residuals = y_test - y_pred
sns.scatterplot(x=y_pred, y=residuals,
                alpha=0.4, ax=axes[1, 0], color='coral')
...
feat_imp_series.nlargest(10).sort_values().plot(
    kind='barh',
    ax=axes[1, 1],
    color='darkgreen'
)
